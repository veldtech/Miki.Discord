...
{
    public partial class CachedDiscordClient : BaseDiscordClient
    {
        public CachedDiscordClient(DiscordClientConfigurations config, IExtendedCacheClient cacheClient) 
            : base(config)
        {
